...
export const EXTRA_QUIZ_METADATA: Record<string, { timeEstimate: string; whatYouGet: string[]; icon: string; color: string }> = {
  'dark-triad-v1':         { timeEstimate: '4 min', whatYouGet: ['Your dominant shadow trait', 'Healthy and shadow forms of each', 'Integration affirmation'], icon: 'dark-triad', color: 'pink-400' },
  ...
  'love-styles-v1':        { timeEstimate: '3 min', whatYouGet: ['Which of 4 Greek love styles you lead with', 'Strengths + shadow', 'Affirmation to carry'], icon: 'love-styles-icon', color: 'pink-400' },
  ...
  'self-compassion-v1':    { timeEstimate: '3 min', whatYouGet: ['Your dominant self-compassion stance', 'Where you self-judge vs self-kind', 'Next-step affirmation'], icon: 'self-compassion-icon', color: 'pink-400' },
  ...
  'relationship-readiness-v1':{ timeEstimate: '3 min', whatYouGet: ['Where you are in readiness', 'What to tend first', 'Non-judgmental mirror'],                      icon: 'relationship-readiness-icon', color: 'pink-400' },
