/**
 * Publish 5 SEO blog articles directly to Supabase.
...
const articles = [
  {
    ...
    title: 'The Complete Guide to Tarot Card Meanings: All 78 Cards Explained',
    excerpt: 'A beginner-friendly guide to all 78 tarot cards — their upright meanings, reversed meanings, and what they mean for love, career, and personal growth.',
    tags: ['tarot', 'guide', 'meanings', 'major arcana', 'minor arcana'],
...
<p>Try your first reading now — it's free at <a href="https://tarotlife.app">tarotlife.app</a>.</p>
  ...
  },
  {
    ...
    title: 'What Is a Celtic Cross Tarot Spread? Complete Guide for Beginners',
    excerpt: 'The Celtic Cross is the most popular tarot spread in the world. Learn what each of the 10 positions means and how to interpret your reading.',
    tags: ['tarot', 'celtic cross', 'spreads', 'guide', 'readings'],
    content: `<article class="blog-post">
...
<p>The Celtic Cross is available in the Arcana app — try it free at <a href="https://tarotlife.app">tarotlife.app</a>.</p>
  ...
  {
    slug: 'daily-horoscope-routine',
    title: 'Your Daily Horoscope Routine: How 3 Minutes Can Change Your Day',
    excerpt: 'A simple 3-minute morning ritual using your horoscope, a tarot card, and a journal entry can transform how you start each day.',
    tags: ['horoscope', 'daily routine', 'self-care', 'astrology', 'mindfulness'],
    content: `<article class="blog-post">
...
<p>Start today at <a href="https://tarotlife.app">tarotlife.app</a>.</p>
  ...
  {
    slug: 'mbti-zodiac-personality-combination',
    title: 'MBTI and Zodiac: What Your Personality Type + Sun Sign Says About You',
    excerpt: 'Your MBTI type meets your zodiac sign — here\'s what the combination reveals about your true personality.',
    tags: ['MBTI', 'zodiac', 'personality', 'astrology', 'psychology'],
    content: `<article class="blog-post">
...
<h3>Aries</h3>
<ul>
<li><strong>ENTJ Aries:</strong> Unstoppable leader. Born to command.</li>
<li><strong>ENFP Aries:</strong> Chaotic enthusiasm personified.</li>
<li><strong>ISTP Aries:</strong> The quiet warrior. Strikes when least expected.</li>
</ul>
<h3>Leo</h3>
<ul>
<li><strong>ENFJ Leo:</strong> The magnetic mentor everyone gravitates toward.</li>
<li><strong>ESFP Leo:</strong> Pure performance energy. Life of every room.</li>
<li><strong>INTJ Leo:</strong> Strategic brilliance with dramatic flair.</li>
</ul>
<h3>Sagittarius</h3>
<ul>
<li><strong>ENTP Sagittarius:</strong> The philosopher who can't sit still.</li>
<li><strong>INFP Sagittarius:</strong> Idealist wanderer chasing meaning.</li>
<li><strong>ESTP Sagittarius:</strong> Adventure incarnate. Zero fear.</li>
</ul>

<h2>Earth Signs + MBTI</h2>
<h3>Taurus</h3>
<ul>
<li><strong>ISFJ Taurus:</strong> The ultimate caretaker. Loyal to the bone.</li>
<li><strong>ESTJ Taurus:</strong> Builds empires slowly and permanently.</li>
<li><strong>INFP Taurus:</strong> Gentle artist with immovable values.</li>
</ul>
<h3>Virgo</h3>
<ul>
<li><strong>ISTJ Virgo:</strong> Peak precision. Nothing escapes their notice.</li>
<li><strong>INFJ Virgo:</strong> The analytical empath. Sees everything.</li>
<li><strong>ENTP Virgo:</strong> Brilliant chaos organized into systems.</li>
</ul>
<h3>Capricorn</h3>
<ul>
<li><strong>INTJ Capricorn:</strong> The master strategist. Playing chess while others play checkers.</li>
<li><strong>ENTJ Capricorn:</strong> Born CEO energy.</li>
<li><strong>ISFP Capricorn:</strong> Quiet ambition disguised as gentleness.</li>
</ul>

<h2>Air Signs + MBTI</h2>
<h3>Gemini</h3>
<ul>
<li><strong>ENTP Gemini:</strong> The ultimate conversationalist. 47 ideas per minute.</li>
<li><strong>INFJ Gemini:</strong> Deep thinker who communicates brilliantly.</li>
<li><strong>ESTP Gemini:</strong> Quick-witted and impossible to pin down.</li>
</ul>
<h3>Libra</h3>
<ul>
<li><strong>ENFJ Libra:</strong> The diplomat everyone trusts.</li>
<li><strong>ISFP Libra:</strong> Creates beauty wherever they go.</li>
<li><strong>INTP Libra:</strong> Balances logic with aesthetics.</li>
</ul>
<h3>Aquarius</h3>
<ul>
<li><strong>INTP Aquarius:</strong> The visionary inventor.</li>
<li><strong>ENFP Aquarius:</strong> Revolutionary optimist. Changes the world with enthusiasm.</li>
<li><strong>INTJ Aquarius:</strong> Cold genius with a humanitarian heart.</li>
</ul>

<h2>Water Signs + MBTI</h2>
<h3>Cancer</h3>
<ul>
<li><strong>ISFJ Cancer:</strong> Emotional fortress. Protects everyone.</li>
<li><strong>ENFJ Cancer:</strong> The nurturing leader.</li>
<li><strong>INFP Cancer:</strong> Feels everything on a cosmic level.</li>
</ul>
<h3>Scorpio</h3>
<ul>
<li><strong>INTJ Scorpio:</strong> Strategic intensity. Never reveals their hand.</li>
<li><strong>INFJ Scorpio:</strong> Sees through everyone. Understands everything.</li>
<li><strong>ENTJ Scorpio:</strong> Power and transformation combined.</li>
</ul>
<h3>Pisces</h3>
<ul>
<li><strong>INFP Pisces:</strong> The purest dreamer. Lives between worlds.</li>
<li><strong>ENFJ Pisces:</strong> Healing presence. Makes everyone feel seen.</li>
<li><strong>INTP Pisces:</strong> Analytical mystic. Logic meets intuition.</li>
</ul>

<h2>Find Your Combination</h2>
<p>Take both assessments for free in the Arcana app. Your MBTI quiz result is saved alongside your zodiac sign on your profile, giving you a comprehensive personality snapshot.</p>
<p>Discover your combination at <a href="https://tarotlife.app">tarotlife.app</a>.</p>
</article>`,
  },
  {
    slug: 'five-love-languages-explained',
    title: '5 Love Languages Explained: Which One Are You?',
    excerpt: 'Understanding your love language transforms your relationships. Here\'s what each one means and how to discover yours.',
    tags: ['love language', 'relationships', 'personality quiz', 'self-discovery'],
    content: `<article class="blog-post">
...
<p>Take the free Love Language quiz in the Arcana app. Your results are saved to your profile and help personalize your experience throughout the app.</p>
...
async function publish() {
  console.log('Publishing 5 blog articles...\n');
  ...
  for (const article of articles) {
    ...
    if (error) {
      ...
      console.log(`    → https://tarotlife.app/blog/${article.slug}`);
    }
  }
