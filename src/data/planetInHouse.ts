...
const interpretations: Record<string, PlanetInHouseInterp> = {
  'Sun-1': {
    ...
    healthy: 'You lead with authentic confidence and inspire others simply by being fully yourself.',
    unhealthy: 'You become self-absorbed and domineering, demanding constant attention and refusing to make room for anyone else.',
  },
  'Sun-2': {
    ...
    healthy: 'You build genuine self-worth from within and use your resources generously to support what you truly value.',
    unhealthy: 'You equate your identity entirely with material wealth and become possessive, hoarding resources out of deep insecurity.',
  },
  'Sun-3': {
    ...
    healthy: 'You share knowledge with genuine curiosity and use your words to build bridges between people and ideas.',
    unhealthy: 'You scatter your energy across too many superficial interests and use cleverness to manipulate rather than connect.',
  },
  'Sun-4': {
    ...
    healthy: 'You create a warm, nurturing home environment and draw strength from your roots while allowing yourself to grow beyond them.',
    unhealthy: 'You cling to the past and use family loyalty as a way to avoid the vulnerability of forging your own independent identity.',
  },
  'Sun-5': {
    ...
    healthy: 'You channel your creative fire into art, love, and play that uplifts both yourself and those around you.',
    unhealthy: 'You chase constant drama and validation through romantic conquests or attention-seeking displays, unable to find joy within.',
  },
  'Sun-6': {
    ...
    healthy: 'You serve others with skill and humility, finding deep satisfaction in the craft of making everyday life work beautifully.',
    unhealthy: 'You become a perfectionist workaholic who criticizes everyone, including yourself, and ties all self-worth to productivity.',
  },
  'Sun-7': {
    ...
    healthy: 'You bring your full self to partnerships and grow through the honest give-and-take of committed relationships.',
    unhealthy: 'You lose yourself entirely in others, becoming dependent on a partner to define who you are and unable to stand alone.',
  },
  'Sun-8': {
    ...
    healthy: 'You face life\'s depths with courage and use your transformative experiences to help others through their own dark passages.',
    unhealthy: 'You become obsessed with control and power, manipulating others through secrecy and emotional intensity to avoid your own vulnerability.',
  },
  'Sun-9': {
    ...
    healthy: 'You pursue wisdom with an open mind and share your expansive worldview in ways that genuinely broaden others\' horizons.',
    unhealthy: 'You become a self-righteous preacher who believes only your truth matters and uses philosophy to avoid the messy details of real life.',
  },
  'Sun-10': {
    ...
    healthy: 'You lead with integrity and build a public legacy that reflects your authentic values and serves the greater good.',
    unhealthy: 'You sacrifice personal relationships and inner life on the altar of ambition, defining yourself solely by status and external achievement.',
  },
  'Sun-11': {
    ...
    healthy: 'You contribute your unique gifts to a community vision and form friendships that inspire both personal and collective growth.',
    unhealthy: 'You hide behind group identity to avoid personal accountability and become so focused on ideals that you neglect the people right in front of you.',
  },
  'Sun-12': {
    ...
    healthy: 'You cultivate a rich inner life and use your deep sensitivity to bring compassion and spiritual insight to the world.',
    unhealthy: 'You retreat into isolation and escapism, losing yourself in fantasy or addiction because the material world feels too harsh to bear.',
  },
  'Moon-1': {
    ...
    healthy: 'You honor your emotional nature openly, creating authentic connections through your willingness to be emotionally present and visible.',
    unhealthy: 'You become a slave to mood swings, projecting your emotional storms onto everyone around you and taking everything personally.',
  },
  'Moon-4': {
    ...
    healthy: 'You create a deeply nurturing home life and consciously heal inherited family patterns so they are not passed on.',
    unhealthy: 'You remain emotionally enmeshed with your family of origin, unable to set boundaries or move beyond childhood wounds.',
  },
  'Moon-7': {
    ...
    healthy: 'You form deeply attuned emotional partnerships where mutual care and vulnerability create genuine intimacy.',
    unhealthy: 'You become emotionally codependent, losing your own emotional center by absorbing your partner\'s feelings as your own.',
  },
  'Moon-10': {
    ...
    healthy: 'You bring genuine emotional intelligence to your professional life, earning public trust through authentic care and sensitivity.',
    unhealthy: 'You seek emotional validation through career achievement and public approval, neglecting your private emotional needs until they erupt publicly.',
  },
  'Venus-5': {
    ...
    healthy: 'You express love and creativity with generous warmth, turning everyday moments into something beautiful for yourself and others.',
    unhealthy: 'You become addicted to the thrill of new romance and external admiration, unable to sustain love once the initial sparkle fades.',
  },
  'Venus-7': {
    ...
    healthy: 'You cultivate relationships built on mutual respect and genuine harmony, bringing grace and fairness to every partnership.',
    unhealthy: 'You avoid all conflict to maintain a surface-level peace, compromising your own needs and values to keep a relationship looking perfect.',
  },
  'Mars-1': {
    ...
    healthy: 'You channel your fierce energy into courageous action and inspire others through your bold, direct approach to life.',
    unhealthy: 'You become recklessly aggressive, picking fights and bulldozing over others because you confuse domination with strength.',
  },
  'Mars-10': {
    ...
    healthy: 'You pursue professional goals with disciplined intensity and lead others through decisive, courageous action.',
    unhealthy: 'You become ruthlessly competitive in your career, burning bridges and treating people as obstacles to be conquered on your climb to the top.',
  },
  'Jupiter-9': {
    ...
    healthy: 'You inspire others with your generous wisdom and use your good fortune to open doors for those who have fewer opportunities.',
    unhealthy: 'You over-extend yourself with grandiose promises, become preachy about your beliefs, and rely on luck rather than doing the necessary work.',
  },
  'Saturn-10': {
    ...
    healthy: 'You build lasting professional authority through patience, integrity, and a willingness to earn every ounce of respect you receive.',
    unhealthy: 'You become cold and rigid in your pursuit of status, sacrificing warmth and human connection for a legacy built on fear rather than respect.',
  },
};
...
export function getGenericHouseInterp(planet: Planet, house: number): PlanetInHouseInterp {
  ...
  return {
    ...
    healthy: `You channel your ${pKey} constructively through ${hKey}, finding authentic fulfillment in this area of life.`,
    unhealthy: `You misuse your ${pKey} in the domain of ${hKey}, either avoiding it entirely or expressing it in compulsive, unconscious ways.`,
  };
}
