...
export function HoroscopeSection({ onShowPaywall }: HoroscopeSectionProps) {
  ...
  const weeklyInsights = t('horoscope.weeklyInsights', { returnObjects: true }) as string[];
  const monthlyThemes = t('horoscope.monthlyThemes', { returnObjects: true }) as string[];
  ...
  const handleMonthView = () => {
    if (!profile?.isPremium) {
      onShowPaywall(t('horoscope.paywallFeatures.monthly'));
      return;
    }
    setPeriod('month');
  };
  ...
  const weekdayInitials = [
    t('horoscope.weekdayInitials.mon'),
    t('horoscope.weekdayInitials.tue'),
    t('horoscope.weekdayInitials.wed'),
    t('horoscope.weekdayInitials.thu'),
    t('horoscope.weekdayInitials.fri'),
    t('horoscope.weekdayInitials.sat'),
    t('horoscope.weekdayInitials.sun'),
  ];
